...
export namespace Prisma {
  ...
  */
            ...
            Product: {
                ...
                operations: {
                    ...
                    count: {
                        ...
                        result:
                            | $Utils.Optional<ProductCountAggregateOutputType>
                            | number;
                    };
                };
            };
     ...
     * ProductCountOutputType without action
     */
    export type ProductCountOutputTypeCountOrderArgs<
        ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    > = {
        where?: OrderWhereInput;
    };
        ...
        Prisma.PrismaPromise<
            Array<
                PickEnumerable<ProductGroupByOutputType, T["by"]> & {
                    [P in keyof T &
                        keyof ProductGroupByOutputType]: P extends "_count"
                        ? T[P] extends boolean
                            ? number
    ...
    > {
        ...
        >(
            args: SubsetIntersection<T, ProductGroupByArgs, OrderByArg> &
                InputErrors,
        ): {} extends InputErrors
    ...
    export type EnumStatusWithAggregatesFilter<$PrismaModel = never> = {
        ...
        notIn?: $Enums.Status[] | ListEnumStatusFieldRefInput<$PrismaModel>;
        not?:
            | NestedEnumStatusWithAggregatesFilter<$PrismaModel>
            | $Enums.Status;
        _count?: NestedIntFilter<$PrismaModel>;
    ...
    export type ProductUpdateOneRequiredWithoutOrderNestedInput = {
        ...
        update?: XOR<
            XOR<
                ProductUpdateToOneWithWhereWithoutOrderInput,
    ...
    export type OrderUpdateManyWithWhereWithoutProductInput = {
        ...
        data: XOR<
            OrderUpdateManyMutationInput,
            OrderUncheckedUpdateManyWithoutProductInput
        >;
    };
